  ...
  var mousemove = function(d) {
    Tooltip
      .html('<h1>' + d.company + '</h1>'
        ...
        + '<span class="industry">' + d.industry + '</span>' + '<br/>' 
        + '<span class="revenue">Yearly revenue:' + d.value + '</span>' + '<br/>'
        + '<span class="cpr">CEO compensation:' + d.cpr + '</span>' + '<br/>'
        + " and a total of " + employees + 'employees.</span>' + '</p>'
        )
